...
function convertSingleSourceToKnowledgeBase(source) {
...
async function aggregateWithLLM(sources) {
...
function fallbackAggregation(sources) {
...
export async function getAggregatedKnowledgeBase(userId) {
    ...
    const kb = data?.knowledge_base_summary;
    if (!kb) {
